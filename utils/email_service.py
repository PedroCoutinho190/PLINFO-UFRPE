...
class EmailService:
    ...
    def send_code(self, email_destino):
        """
        ...
        try:
            ...
            servidor.sendmail(self.EMAIL_REMETENTE, email_destino, msg.as_string())
            servidor.quit()
    ...
    def check_code(self, email):
        ...
        """
        codigo_real = self.send_code(email)
